...
export default function FinanceDashboard() {
  ...
  const totalQuoteValue = filteredData.reduce(
    (sum, q) =>
      sum + Number(q["Quote Value"]?.toString().replace(/,/g, "") || 0),
    0
  );
  ...
  return (
    <div style={{ padding: 24, background: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          <h4 style={{ color: "#64748b", margin: 0, fontSize: 14 }}>
            Total Quotations
          </h4>
          <p
            style={{
        ...
        >
          <h4 style={{ color: "#64748b", margin: 0, fontSize: 14 }}>Revenue</h4>
          <p
            style={{
              fontSize: 28,
              fontWeight: 700,
